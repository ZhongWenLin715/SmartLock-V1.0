...
* @{
*/
#define PRODUCT_KEY "d4ae5caa84f74218bc5af3d0aacf8d75"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "98a33cd34ee44d6f8c4deace9b7728d5"
...
* @{
*/
#define key_BYTEOFFSET                    0
#define key_BITOFFSET                     0
#define key_LEN                           1

#define open_num_RATIO                         1
#define open_num_ADDITION                      0
#define open_num_MIN                           0
#define open_num_MAX                           50
#define harm_gas_RATIO                         1
#define harm_gas_ADDITION                      0
#define harm_gas_MIN                           0
#define harm_gas_MAX                           3000
/**@} */
...
typedef struct {
  bool valuekey;
  uint32_t valueopen_num;
  uint32_t valueharm_gas;
} dataPoint_t;
...
typedef struct {
  uint8_t wBitBuf[COUNT_W_BIT];
  uint8_t valueopen_num;
  uint16_t valueharm_gas;
} devStatus_t; 
